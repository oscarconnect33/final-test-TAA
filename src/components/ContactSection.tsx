      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-8">
        ...
        <div className="grid lg:grid-cols-5 gap-12 max-w-5xl mx-auto">
          ...
          <div className="lg:col-span-2 animate-fade-in">
            ...
            <div className="mt-8 bg-gradient-card border border-auto-border rounded-xl p-6 shadow-card">
              <p className="text-muted-foreground">
                <span className="font-semibold text-primary">Prefer email?</span> Contact us directly at{" "}
                <span className="text-auto-blue font-semibold">info@topautoadvisors.com</span>
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-3 animate-slide-in-right">
            <form className="bg-gradient-card border border-auto-border rounded-2xl p-8 shadow-card">
