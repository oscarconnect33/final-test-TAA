    ...
    <section id="who-we-help" className="py-20 md:py-24 bg-background">
      <div className="max-w-6xl mx-auto px-6 sm:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-24">
          ...
          <div className="group bg-gradient-card border border-auto-border rounded-3xl p-12 h-[500px] shadow-card hover:shadow-glow transition-all duration-500 hover:-translate-y-2 animate-fade-in">
            <div className="flex flex-col items-center text-center h-full justify-center">
              <div className="w-60 h-60 rounded-2xl flex items-center justify-center mb-8 shadow-glow group-hover:scale-110 transition-transform duration-300">
                <img
          ...
          <div
            className="group bg-gradient-card border border-auto-border rounded-3xl p-12 h-[500px] shadow-card hover:shadow-glow transition-all duration-500 hover:-translate-y-2 animate-fade-in"
          ...
          >
            <div className="flex flex-col items-center text-center h-full justify-center">
              ...
              <h3 className="text-3xl font-bold text-foreground mb-5 text-balance">
...
<div className="text-center animate-fade-in" style={{ animationDelay: '0.4s' }}>
  <div className="bg-gradient-card border border-auto-border rounded-2xl p-12 shadow-card max-w-5xl mx-auto px-6 sm:px-10">
    <p className="text-2xl md:text-3xl text-muted-foreground mb-4 italic">
      Most people aren't good with auto finance paperwork.
    </p>
    <p className="text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-auto-blue to-primary leading-[1.3] pb-4">
